...
* **Persistent Object Tracking:** Integrates built-in tracking algorithms to assign unique, consistent IDs to detected objects as they move across frames.
* **Live Annotation:** Automatically overlays bounding boxes, confidence scores, and tracking labels onto the video stream.

## Repository Structure
* `app.py` - The core Python script managing the webcam stream and AI pipeline[cite: 1].
...
```bash
   git clone [https://github.com/suwathism7-png/CodeAlpha_Object_Detection_And_Tracking.git](https://github.com/suwathism7-png/CodeAlpha_Object_Detection_And_Tracking.git)
